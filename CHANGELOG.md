...
- Anchor the ephemeral SDN zone regex so automatic cleanup is less likely to delete unrelated pre-existing zones whose names share a 7-character prefix with provider zones
